...
namespace axosimple
{
    ...
    public partial class Inputs : AXSharp.Connector.ITwinObject
    {
        ...
        public async Task<Pocos.axosimple.Inputs> OnlineToPlainAsync()
        {
            Pocos.axosimple.Inputs plain = new Pocos.axosimple.Inputs();
        ...
        public async Task<Pocos.axosimple.Inputs> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.Inputs plain = new Pocos.axosimple.Inputs();
            plain.P0 = P0.Select(p => p.LastValue).ToArray();
            plain.P1 = P1.Select(p => p.LastValue).ToArray();
        ...
        protected async Task<Pocos.axosimple.Inputs> OnlineToPlainAsync(Pocos.axosimple.Inputs plain)
        {
            plain.P0 = P0.Select(p => p.LastValue).ToArray();
            plain.P1 = P1.Select(p => p.LastValue).ToArray();
            plain.A0 = A0.Select(p => p.LastValue).ToArray();
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.Inputs plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.Inputs plain)
        {
            var _P0_i_FE8484DAB3 = 0;
#pragma warning disable CS0612
            P0.Select(p => p.LethargicWrite(plain.P0[_P0_i_FE8484DAB3++])).ToArray();
...
#pragma warning restore CS0612
        ...
        public async Task<Pocos.axosimple.Inputs> ShadowToPlainAsync()
        {
            Pocos.axosimple.Inputs plain = new Pocos.axosimple.Inputs();
        ...
        protected async Task<Pocos.axosimple.Inputs> ShadowToPlainAsync(Pocos.axosimple.Inputs plain)
        {
            plain.P0 = P0.Select(p => p.Shadow).ToArray();
            plain.P1 = P1.Select(p => p.Shadow).ToArray();
            plain.A0 = A0.Select(p => p.Shadow).ToArray();
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.axosimple.Inputs plain)
        {
            var _P0_i_FE8484DAB3 = 0;
        ...
        ///</summary>
        public async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.Inputs plain, Pocos.axosimple.Inputs latest = null)
        {
        ...
        public Pocos.axosimple.Inputs CreateEmptyPoco()
        {
            return new Pocos.axosimple.Inputs();
        }
