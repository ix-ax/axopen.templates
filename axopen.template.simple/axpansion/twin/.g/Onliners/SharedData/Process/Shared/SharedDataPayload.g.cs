...
namespace axosimple
{
    public partial class SharedDataPayload : AXOpen.Data.AxoDataEntity
    {
        ...
        public SharedDataPayload(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
        ...
        public new async Task<Pocos.axosimple.SharedDataPayload> OnlineToPlainAsync()
        {
            Pocos.axosimple.SharedDataPayload plain = new Pocos.axosimple.SharedDataPayload();
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.SharedDataPayload> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.SharedDataPayload plain = new Pocos.axosimple.SharedDataPayload();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.SharedDataPayload> _OnlineToPlainNoacAsync(Pocos.axosimple.SharedDataPayload plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.SharedDataPayload plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.SharedDataPayload plain)
        {
            await base._PlainToOnlineNoacAsync(plain);
#pragma warning disable CS0612
            LastStation.LethargicWrite(plain.LastStation);
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.SharedDataPayload> ShadowToPlainAsync()
        {
            Pocos.axosimple.SharedDataPayload plain = new Pocos.axosimple.SharedDataPayload();
        ...
        protected async Task<Pocos.axosimple.SharedDataPayload> ShadowToPlainAsync(Pocos.axosimple.SharedDataPayload plain)
        {
            await base.ShadowToPlainAsync(plain);
            plain.LastStation = LastStation.Shadow;
            plain.NextStation = NextStation.Shadow;
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.axosimple.SharedDataPayload plain)
        {
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.SharedDataPayload plain, Pocos.axosimple.SharedDataPayload latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.SharedDataPayload CreateEmptyPoco()
        {
            return new Pocos.axosimple.SharedDataPayload();
        }
    }
}