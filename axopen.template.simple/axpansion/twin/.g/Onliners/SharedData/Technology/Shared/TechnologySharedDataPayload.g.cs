...
namespace axosimple
{
    public partial class TechnologySharedDataPayload : AXOpen.Data.AxoDataEntity
    {
        ...
        public TechnologySharedDataPayload(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
        ...
        public new async Task<Pocos.axosimple.TechnologySharedDataPayload> OnlineToPlainAsync()
        {
            Pocos.axosimple.TechnologySharedDataPayload plain = new Pocos.axosimple.TechnologySharedDataPayload();
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.TechnologySharedDataPayload> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.TechnologySharedDataPayload plain = new Pocos.axosimple.TechnologySharedDataPayload();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.TechnologySharedDataPayload> _OnlineToPlainNoacAsync(Pocos.axosimple.TechnologySharedDataPayload plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.TechnologySharedDataPayload plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.TechnologySharedDataPayload plain)
        {
            await base._PlainToOnlineNoacAsync(plain);
#pragma warning disable CS0612
            IdealCycleTime.LethargicWrite(plain.IdealCycleTime);
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.TechnologySharedDataPayload> ShadowToPlainAsync()
        {
            Pocos.axosimple.TechnologySharedDataPayload plain = new Pocos.axosimple.TechnologySharedDataPayload();
        ...
        protected async Task<Pocos.axosimple.TechnologySharedDataPayload> ShadowToPlainAsync(Pocos.axosimple.TechnologySharedDataPayload plain)
        {
            await base.ShadowToPlainAsync(plain);
            plain.IdealCycleTime = IdealCycleTime.Shadow;
            plain.WarningCycleTime = WarningCycleTime.Shadow;
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.axosimple.TechnologySharedDataPayload plain)
        {
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.TechnologySharedDataPayload plain, Pocos.axosimple.TechnologySharedDataPayload latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.TechnologySharedDataPayload CreateEmptyPoco()
        {
            return new Pocos.axosimple.TechnologySharedDataPayload();
        }
    }
}