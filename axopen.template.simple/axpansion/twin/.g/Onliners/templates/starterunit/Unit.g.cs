...
namespace axosimple.StarterUnitTemplate
{
    ...
    {
        public axosimple.StarterUnitTemplate.UnitObjects X { get; }

        public axosimple.StarterUnitTemplate.GroundSequence Ground { get; }

        public axosimple.StarterUnitTemplate.AutomatSequence Auto { get; }

        public axosimple.StarterUnitTemplate.ServiceMode Service { get; }
        ...
        public Unit(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
            ...
            X = new axosimple.StarterUnitTemplate.UnitObjects(this, "X", "X");
            Ground = new axosimple.StarterUnitTemplate.GroundSequence(this, "Ground", "Ground");
            Auto = new axosimple.StarterUnitTemplate.AutomatSequence(this, "Auto", "Auto");
            Service = new axosimple.StarterUnitTemplate.ServiceMode(this, "Service", "Service");
