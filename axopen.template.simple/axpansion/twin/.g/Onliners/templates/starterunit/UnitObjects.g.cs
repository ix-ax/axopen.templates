...
namespace axosimple.StarterUnitTemplate
{
    ...
    {
        public axosimple.StarterUnitTemplate.Components C { get; }

        public axosimple.StarterUnitTemplate.ProcessDataManager PD { get; }

        public axosimple.StarterUnitTemplate.TechnologyDataManager TD { get; }
        ...
        public UnitObjects(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
            ...
            C = new axosimple.StarterUnitTemplate.Components(this, "C", "C");
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.UnitObjects> OnlineToPlainAsync()
        {
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.UnitObjects> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.UnitObjects plain = new Pocos.axosimple.StarterUnitTemplate.UnitObjects();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.StarterUnitTemplate.UnitObjects> _OnlineToPlainNoacAsync(Pocos.axosimple.StarterUnitTemplate.UnitObjects plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.StarterUnitTemplate.UnitObjects plain)
        {
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.UnitObjects> ShadowToPlainAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.UnitObjects plain = new Pocos.axosimple.StarterUnitTemplate.UnitObjects();
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.StarterUnitTemplate.UnitObjects plain, Pocos.axosimple.StarterUnitTemplate.UnitObjects latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.StarterUnitTemplate.UnitObjects CreateEmptyPoco()
        {
            return new Pocos.axosimple.StarterUnitTemplate.UnitObjects();
        }
    }
}