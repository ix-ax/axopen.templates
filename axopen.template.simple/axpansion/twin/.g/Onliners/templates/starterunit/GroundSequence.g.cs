...
namespace axosimple.StarterUnitTemplate
{
    public partial class GroundSequence : AXOpen.Core.AxoSequencerContainer, IModeContainer
    {
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.GroundSequence> OnlineToPlainAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.GroundSequence plain = new Pocos.axosimple.StarterUnitTemplate.GroundSequence();
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.GroundSequence> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.GroundSequence plain = new Pocos.axosimple.StarterUnitTemplate.GroundSequence();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.StarterUnitTemplate.GroundSequence> _OnlineToPlainNoacAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain)
        {
            await base._PlainToOnlineNoacAsync(plain);
            var _Steps_i_FE8484DAB3 = 0;
#pragma warning disable CS0612
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.GroundSequence> ShadowToPlainAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.GroundSequence plain = new Pocos.axosimple.StarterUnitTemplate.GroundSequence();
        ...
        protected async Task<Pocos.axosimple.StarterUnitTemplate.GroundSequence> ShadowToPlainAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain)
        {
            await base.ShadowToPlainAsync(plain);
            plain.Steps = Steps.Select(async p => await p.ShadowToPlainAsync()).Select(p => p.Result).ToArray();
            plain.MoveToWork = await MoveToWork.ShadowToPlainAsync();
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain)
        {
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.StarterUnitTemplate.GroundSequence plain, Pocos.axosimple.StarterUnitTemplate.GroundSequence latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.StarterUnitTemplate.GroundSequence CreateEmptyPoco()
        {
            return new Pocos.axosimple.StarterUnitTemplate.GroundSequence();
        }
    }
}