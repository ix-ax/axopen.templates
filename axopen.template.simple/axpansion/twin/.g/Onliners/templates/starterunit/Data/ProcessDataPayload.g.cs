...
namespace axosimple.StarterUnitTemplate
{
    public partial class ProcessDataPayload : AXOpen.Data.AxoDataEntity
    {
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload> OnlineToPlainAsync()
        {
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload plain = new Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload> _OnlineToPlainNoacAsync(Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload> ShadowToPlainAsync()
        {
            Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload plain = new Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload();
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload plain, Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload CreateEmptyPoco()
        {
            return new Pocos.axosimple.StarterUnitTemplate.ProcessDataPayload();
        }
    }
}