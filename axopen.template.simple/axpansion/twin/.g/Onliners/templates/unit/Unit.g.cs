...
namespace axosimple.UnitTemplate
{
    public partial class Unit : axosimple.BaseUnit.UnitBase
    {
        ...
        public new async Task<Pocos.axosimple.UnitTemplate.Unit> OnlineToPlainAsync()
        {
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.UnitTemplate.Unit> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.UnitTemplate.Unit plain = new Pocos.axosimple.UnitTemplate.Unit();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.UnitTemplate.Unit> _OnlineToPlainNoacAsync(Pocos.axosimple.UnitTemplate.Unit plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.UnitTemplate.Unit plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.UnitTemplate.Unit plain)
        {
            await base._PlainToOnlineNoacAsync(plain);
#pragma warning disable CS0612
            await this.UnitObjects._PlainToOnlineNoacAsync(plain.UnitObjects);
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.UnitTemplate.Unit> ShadowToPlainAsync()
        {
            Pocos.axosimple.UnitTemplate.Unit plain = new Pocos.axosimple.UnitTemplate.Unit();
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.UnitTemplate.Unit plain, Pocos.axosimple.UnitTemplate.Unit latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.UnitTemplate.Unit CreateEmptyPoco()
        {
            return new Pocos.axosimple.UnitTemplate.Unit();
        }
    }
}