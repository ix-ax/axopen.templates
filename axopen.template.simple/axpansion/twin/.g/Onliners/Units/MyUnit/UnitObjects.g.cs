...
namespace axosimple.MyUnit
{
    ...
    {
        public axosimple.MyUnit.Components C { get; }

        public axosimple.MyUnit.ProcessDataManager PD { get; }

        public axosimple.MyUnit.TechnologyDataManager TD { get; }

        [AXOpen.Data.PersistentAttribute("MyUnit")]
        ...
        public UnitObjects(AXSharp.Connector.ITwinObject parent, string readableTail, string symbolTail) : base(parent, readableTail, symbolTail)
        {
            ...
            C = new axosimple.MyUnit.Components(this, "C", "C");
            PD = new axosimple.MyUnit.ProcessDataManager(this, "PD", "PD");
            TD = new axosimple.MyUnit.TechnologyDataManager(this, "TD", "TD");
        ...
        public new async Task<Pocos.axosimple.MyUnit.UnitObjects> OnlineToPlainAsync()
        {
            Pocos.axosimple.MyUnit.UnitObjects plain = new Pocos.axosimple.MyUnit.UnitObjects();
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.MyUnit.UnitObjects> _OnlineToPlainNoacAsync()
        {
            Pocos.axosimple.MyUnit.UnitObjects plain = new Pocos.axosimple.MyUnit.UnitObjects();
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
...
#pragma warning restore CS0612
        ...
        [Obsolete("This method should not be used if you indent to access the controllers data. Use `OnlineToPlain` instead.")]
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        protected async Task<Pocos.axosimple.MyUnit.UnitObjects> _OnlineToPlainNoacAsync(Pocos.axosimple.MyUnit.UnitObjects plain)
        {
#pragma warning disable CS0612
            await base._OnlineToPlainNoacAsync(plain);
#pragma warning restore CS0612
...
#pragma warning restore CS0612
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToOnlineAsync(Pocos.axosimple.MyUnit.UnitObjects plain)
        {
...
#pragma warning restore CS0612
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        public async Task _PlainToOnlineNoacAsync(Pocos.axosimple.MyUnit.UnitObjects plain)
        {
            await base._PlainToOnlineNoacAsync(plain);
#pragma warning disable CS0612
            await this.C._PlainToOnlineNoacAsync(plain.C);
...
#pragma warning restore CS0612
        ...
        public new async Task<Pocos.axosimple.MyUnit.UnitObjects> ShadowToPlainAsync()
        {
            Pocos.axosimple.MyUnit.UnitObjects plain = new Pocos.axosimple.MyUnit.UnitObjects();
        ...
        protected async Task<Pocos.axosimple.MyUnit.UnitObjects> ShadowToPlainAsync(Pocos.axosimple.MyUnit.UnitObjects plain)
        {
            await base.ShadowToPlainAsync(plain);
            plain.C = await C.ShadowToPlainAsync();
            plain.PD = await PD.ShadowToPlainAsync();
        ...
        public async Task<IEnumerable<ITwinPrimitive>> PlainToShadowAsync(Pocos.axosimple.MyUnit.UnitObjects plain)
        {
        ...
        ///</summary>
        public new async Task<bool> DetectsAnyChangeAsync(Pocos.axosimple.MyUnit.UnitObjects plain, Pocos.axosimple.MyUnit.UnitObjects latest = null)
        {
            if (latest == null)
        ...
        public new Pocos.axosimple.MyUnit.UnitObjects CreateEmptyPoco()
        {
            return new Pocos.axosimple.MyUnit.UnitObjects();
        }
    }
}