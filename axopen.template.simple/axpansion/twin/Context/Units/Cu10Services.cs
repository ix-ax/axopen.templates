...
namespace axosimple.Cu10
{
    ...
    public class UnitServices : IUnitServices
    {
        ...
        public UnitBase Unit { get; } = Entry.Plc.Context.Cu10;
        ...
        /// </summary>
        public IRepository<Pocos.axosimple.Cu10.TechnologyDataPayload> TechnologySettingsRepository { get; } 
            = new MongoDbRepositorySettings<Pocos.axosimple.Cu10.TechnologyDataPayload>(
                ContextService.DataBaseConnectionString, ContextService.DataBaseName, 
                "Cu10_TechnologySettings").Factory();

        /// <summary>
        /// Gets repository for process settings.
        /// </summary>
        public IRepository<Pocos.axosimple.Cu10.ProcessDataPayload> ProcessSettingsRepository { get; } 
            = new MongoDbRepositorySettings<Pocos.axosimple.Cu10.ProcessDataPayload>(
                ContextService.DataBaseConnectionString, ContextService.DataBaseName, 
                "Cu10_ProcessSettings").Factory();

        /// <summary>
        /// Gets repository for process/production data.
        /// </summary>
        public IRepository<Pocos.axosimple.Cu10.ProcessDataPayload> ProcessDataRepository { get; } 
            = new MongoDbRepositorySettings<Pocos.axosimple.Cu10.ProcessDataPayload>(
                ContextService.DataBaseConnectionString, ContextService.DataBaseName,
                "Cu10_ProcessData").Factory();
        ...
        private void InitializeDataExchange()
        {
            ...
            _contextService.TechnologySettings.Cu10.InitializeRemoteDataExchange(TechnologySettingsRepository);
            _contextService.ProcessSettings.Cu10.InitializeRemoteDataExchange(ProcessSettingsRepository);
            _contextService.ProcessData.Cu10.InitializeRemoteDataExchange(ProcessDataRepository);

            // initialize unit process data manager
            var processDataManager = Entry.Plc.Context.Cu10.X.PD.CreateDataFragments<ProcessDataManager>()!;
            ...
            var technologyDataManager = Entry.Plc.Context.Cu10.X.TD.CreateDataFragments<TechnologyDataManager>();
        ...
        public string Link => @"/Context/Cu10";
